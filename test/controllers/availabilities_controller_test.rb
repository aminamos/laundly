...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { day_of_week: @availability.day_of_week, end_time: @availability.end_time, start_time: @availability.start_time, store_id: @availability.store_id } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { day_of_week: @availability.day_of_week, end_time: @availability.end_time, start_time: @availability.start_time, store_id: @availability.store_id } }
